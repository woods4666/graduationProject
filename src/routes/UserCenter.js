...
class UserCenter extends React.Component{
    ...
    async componentWillMount(){
        ...
        if (result.code==0){
            ...
            this.phone=userResult.info.phone;
            this.setState({
                code:0
            })
        }
    ...
    render(){
        ...
        <div className="order">
            <div className="top order-item">
                <Link to={code==0?"/usercenter/userorder":'/login'}>
                    <Icon type="pay-circle" />
                    <span>待支付</span>
                </Link>
                <Divider type="vertical" />
                <Link to={code==0?"/usercenter/userorder/packing":'/login'}>
                    <Icon type="gift" />
                    <span>待发货</span>
                </Link>
                <Divider type="vertical" />
            ...
            <Link to={code==0?"/usercenter/userorder":'/login'} className="clearfix">
                <Icon type="file-text" />
                <span>我的订单</span>
                <Icon type="right" />
            </Link>
